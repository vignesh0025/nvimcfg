...
M.dap_keymaps = function ()
    ...
    vim.keymap.set('n', '<leader>xn', function() require('dap').step_over() end)
    vim.keymap.set('n', '<leader>xs', function() require('dap').step_into() end)
    vim.keymap.set('n', '<leader>xs', function() require('dap').step_out() end)
    vim.keymap.set('n', '<leader>xt', function() require('dap').toggle_breakpoint() end)
    -- vim.keymap.set('n', '<leader>B', function() require('dap').set_breakpoint() end)
    -- vim.keymap.set('n', '<leader>lp', function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end)
    vim.keymap.set('n', '<Leader>xr', function() require('dap').repl.open() end)
    vim.keymap.set('n', '<Leader>xl', function() require('dap').run_last() end)
    vim.keymap.set({'n', 'v'}, '<leader>uh', function()
