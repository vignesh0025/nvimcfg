...
local plugins = {
...

	{
		...
		config = function ()
			...
			dap.adapters.lldb = {
				type = 'executable',
				command = '/home/vignesh/.local/share/nvim/mason/packages/codelldb/codelldb',
				name = 'lldb'
			}
			dap.configurations.cpp = {
				{
					...
					request = 'launch',
					program = function()
						return vim.fn.input('Path to executable: ', vim.fn.getcwd() .. './target/debug/tui-devel', 'file')
					end,
					cwd = '${workspaceFolder}',
					stopOnEntry = false,
					args = {},
